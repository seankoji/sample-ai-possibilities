"""Local test for the FWD1 (Memory) agent — tests state summary, parsing, and fallback."""
...
def test_llm():
    ...
    mock_game_state_msg = (
        "Tick 42 | FWD1 in attacking third at (75,32). "
        "Ball received from MID. Opponent DEF at (78,30). GK at goal line. "
        "Decide: shoot top-right or cut inside?"
    )
