# AI Team (Strands Diamond) — 1-2-1 Formation Soccer Agents

Five AI agents implementing a 1–2–1 diamond formation with deterministic tactical guardrails, built with
[Strands Agents SDK](https://github.com/strands-agents/sdk-python) and deployed to
[Amazon Bedrock AgentCore](https://docs.aws.amazon.com/bedrock-agentcore/).

Optimized for sub-300ms per-tick decisions using all Amazon Nova Micro routing and spatial guardrails.
...
└── ai-team-strands-diamond/
    ...
    ├── ai-def/         # Center Back        (player 1) — Nova Micro
    ├── ai-mid/         # Left Midfielder    (player 2) — Nova Micro
    ├── ai-fwd1/        # Right Midfielder   (player 3) — Nova Micro
    ├── ai-fwd2/        # Striker            (player 4) — Nova Micro
...
## Player IDs, Roles, and Models

| Player ID | Role             | Formation Pos | Model      | Responsibilities |
|-----------|------------------|---------------|------------|------------------|
| 0         | Goalkeeper (GK)  | GK            | Nova Micro | Goal-line anchor; wide distribution to LM/RM only; never leaves box |
| 1         | Center Back (CB) | CB            | Nova Micro | Defensive anchor; own half only; clears under pressure; marks central runs |
| 2         | Left Mid (LM)    | LM (y ≈ -15)  | Nova Micro | Width & half-space triangles; disciplined shooting; tracks back |
| 3         | Right Mid (RM)   | RM (y ≈ +15)  | Nova Micro | Width & half-space triangles; disciplined shooting; tracks back |
| 4         | Striker (ST)     | ST (y ≈ 0)    | Nova Micro | Pivot & hold-up play (no sprint); disciplined shooting; touchline pressing |
